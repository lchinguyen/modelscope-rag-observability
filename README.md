# GroundTruth: Research Platform for Retrieval Diagnostics and Context-Efficient RAG systems
...
Built for the **Arize @ Google Cloud Partnerships Hackathon** track: [Building Agents for Real-World Challenges](https://rapid-agent.devpost.com/)
...
Demo link: https://youtu.be/-PW7IK5jeOk?si=OabdlX_mI1lTF7zU
